...
export const InstanceProperties = {
  at: proposal("instance/at", ["esnext.string.at"]),
  anchor: stable(null, ["es.string.anchor"]),
  big: stable(null, ["es.string.big"]),
  bind: stable("instance/bind", ["es.function.bind"]),
  blink: stable(null, ["es.string.blink"]),
  bold: stable(null, ["es.string.bold"]),
  codePointAt: stable("instance/code-point-at", ["es.string.code-point-at"]),
  codePoints: proposal("instance/code-points", ["esnext.string.code-points"]),
  concat: stable("instance/concat", ["es.array.concat"], undefined, ["String"]),
  copyWithin: stable("instance/copy-within", ["es.array.copy-within"]),
  description: stable(null, ["es.symbol", "es.symbol.description"]),
  endsWith: stable("instance/ends-with", ["es.string.ends-with"]),
  entries: stable("instance/entries", ArrayNatureIteratorsWithTag),
  every: stable("instance/every", ["es.array.every"]),
  exec: stable(null, ["es.regexp.exec"]),
  fill: stable("instance/fill", ["es.array.fill"]),
  filter: stable("instance/filter", ["es.array.filter"]),
  finally: stable(null, ["es.promise.finally", ...PromiseDependencies]),
  find: stable("instance/find", ["es.array.find"]),
  findIndex: stable("instance/find-index", ["es.array.find-index"]),
  fixed: stable(null, ["es.string.fixed"]),
  flags: stable("instance/flags", ["es.regexp.flags"]),
  flatMap: stable("instance/flat-map", [
    "es.array.flat-map",
    "es.array.unscopables.flat-map",
  ]),
  flat: stable("instance/flat", [], "es.array.flat"),
  fontcolor: stable(null, ["es.string.fontcolor"]),
  fontsize: stable(null, ["es.string.fontsize"]),
  forEach: stable("instance/for-each", [
    "es.array.for-each",
    "web.dom-collections.for-each",
  ]),
  includes: stable("instance/includes", [
    "es.array.includes",
    "es.string.includes",
  ]),
  indexOf: stable("instance/index-of", ["es.array.index-of"]),
  italic: stable(null, ["es.string.italics"]),
  join: stable(null, ["es.array.join"]),
  keys: stable("instance/keys", ArrayNatureIteratorsWithTag),
  lastIndex: stable(null, ["esnext.array.last-index"]),
  lastIndexOf: stable("instance/last-index-of", ["es.array.last-index-of"]),
  lastItem: proposal(null, ["esnext.array.last-item"]),
  link: stable(null, ["es.string.link"]),
  map: stable("instance/map", ["es.array.map"]),
  match: stable(null, ["es.string.match", "es.regexp.exec"]),
  matchAll: proposal("instance/match-all", ["esnext.string.match-all"]),
  name: stable(null, ["es.function.name"]),
  padEnd: stable("instance/pad-end", ["es.string.pad-end"]),
  padStart: stable("instance/pad-start", ["es.string.pad-start"]),
  reduce: stable("instance/reduce", ["es.array.reduce"]),
  reduceRight: stable("instance/reduce-right", ["es.array.reduce-right"]),
  repeat: stable("instance/repeat", ["es.string.repeat"]),
  replace: stable(null, ["es.string.replace", "es.regexp.exec"]),
  replaceAll: proposal("instance/replace-all", ["esnext.string.replace-all"]),
  reverse: stable("instance/reverse", ["es.array.reverse"]),
  search: stable(null, ["es.string.search", "es.regexp.exec"]),
  slice: stable("instance/slice", ["es.array.slice"]),
  small: stable(null, ["es.string.small"]),
  some: stable("instance/some", ["es.array.some"]),
  sort: stable("instance/sort", ["es.array.sort"]),
  splice: stable("instance/splice", ["es.array.splice"]),
  split: stable(null, ["es.string.split", "es.regexp.exec"]),
  startsWith: stable("instance/starts-with", ["es.string.starts-with"]),
  ...
  trim: stable("instance/trim", ["es.string.trim"]),
  trimEnd: stable("instance/trim-end", ["es.string.trim-end"]),
  trimLeft: stable("instance/trim-left", ["es.string.trim-start"]),
  trimRight: stable("instance/trim-right", ["es.string.trim-end"]),
  trimStart: stable("instance/trim-start", ["es.string.trim-start"]),
  values: stable("instance/values", ArrayNatureIteratorsWithTag),

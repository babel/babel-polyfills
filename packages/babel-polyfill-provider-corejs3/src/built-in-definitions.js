...
export const BuiltIns: ObjectMap<CoreJSPolyfillDescriptor> = {
  ...
  Map: define("map", MapDependencies),
  Number: define(null, ["es.number.constructor"]),
  Observable: define("observable", [
    "esnext.observable",
    "esnext.symbol.observable",
    "es.object.to-string",
    ...CommonIteratorsWithTag,
  ]),
  Promise: define("promise", PromiseDependencies),
  RegExp: define(null, [
    "es.regexp.constructor",
    "es.regexp.exec",
    "es.regexp.to-string",
  ]),
  Set: define("set", SetDependencies),
  Symbol: define("symbol", SymbolDependencies),
  URL: define("url", ["web.url", ...URLSearchParamsDependencies]),
  URLSearchParams: define("url-search-params", URLSearchParamsDependencies),
  WeakMap: define("weak-map", WeakMapDependencies),
  WeakSet: define("weak-set", WeakSetDependencies),
